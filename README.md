...
* Participantes y Gastos: Añade personas y registra quién pagó qué en segundos.
...
* Gestión de Categorías: Crea y elimina categorías personalizadas con emojis.

# 🛠️ Tecnologías Usadas

* HTML5 & JavaScript (Vanilla): Lógica rápida y ligera sin frameworks pesados.

* Tailwind CSS: Diseño moderno, responsivo y adaptado a móviles (Mobile-First).
